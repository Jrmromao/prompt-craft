          ...
          <Card className="border-2 border-green-200 relative">
            ...
            <CardContent>
              ...
              <ul className="space-y-2 mb-6 text-sm">
                ...
                <Feature highlight>Advanced model routing</Feature>
                <Feature highlight>Response caching (40% savings)</Feature>
          ...
          <Card className="border-2 border-blue-600 relative shadow-xl scale-105">
            ...
            <CardContent>
              ...
              <ul className="space-y-2 mb-6 text-sm">
                ...
                <Feature highlight>Automatic prompt optimization</Feature>
                <Feature highlight>Multi-provider support</Feature>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span>You Pay:</span>
                  <span className="font-bold text-blue-600">$9/month</span>
                </div>
                <div className="border-t pt-2 flex justify-between">
                  <span className="font-semibold">Net Savings:</span>
                  <span className="font-bold text-green-600">$81/month</span>
                </div>
                <p className="text-center text-xs text-gray-600 mt-2">ROI: 9x</p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">
                Upgrade when you're spending $100+/month on AI. At that point, even Starter ($9) will save you $30-50/month net.
              </p>
            </div>
            <div>
