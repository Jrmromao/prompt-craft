...
export function ReviewDialog({ open, onOpenChange, content, onModerate }: ReviewDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label>Author</Label>
            <p className="text-sm text-gray-500">{content.author.name || content.author.email}</p>
          </div>
          <div className="space-y-2">
            <Label>Reports</Label>
            <p className="text-sm text-gray-500">
