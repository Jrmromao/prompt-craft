...
describe('SDK Advanced LLM Features', () => {
    ...
    describe('Streaming Support', () => {
        it('should pass through streaming parameter', async () => {
            ...
            expect(mockClient.chat.completions.create).toHaveBeenCalledWith(expect.objectContaining({ stream: true }));
        });
    ...
    describe('Function Calling', () => {
        it('should pass through function definitions', async () => {
            ...
            expect(mockClient.chat.completions.create).toHaveBeenCalledWith(expect.objectContaining({ functions }));
        });
    ...
    describe('Vision Support', () => {
        ...
        it('should not apply smart routing to vision models', () => {
            ...
            const result = pc.selectOptimalModel('gpt-4-vision-preview', messages);
