      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl bg-muted p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              className="rounded bg-gradient-to-r from-purple-600 to-pink-600 px-4 py-2 font-semibold text-white shadow transition hover:from-purple-700 hover:to-pink-700"
              onClick={async () => {
                try {
