...
test.describe('Stripe Subscription Flow', () => {
  test('User can see the subscription/checkout button and mock Stripe checkout', async ({
    page,
    context,
  }) => {
